...
function show_magicians4(magician4) {
    magician4.forEach(function (magicians) { return console.log(magicians); });
}
function make_great2(magician4) {
    return magician4.map(function (magicians) { return "the great" + magicians; });
}
//define a array of magicians names
var magician4 = ["iqra", "arsalan", "maima"];
var great_magicians5 = make_great2(__spreadArray([], magician4, true));
