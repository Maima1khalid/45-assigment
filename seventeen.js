...
// copy excercise 16
var guestlist3 = ["iqra", "arsalan", "maima"];
var canNotCome1 = "iqra";
...
//middle guest
var names_2 = "maheen";
var ind_ex = guestlist3.length / 2;
...
while (guestlist3.length > 2) {
    ...
    console.log("dear, ".concat(removePerson, " sorry i can't invite for a diner"));
}
//print massage for those who are still invite
guestlist3.forEach(function (name) {
    console.log("dear, ".concat(name, " you are still ivited for the dinner"));
});
